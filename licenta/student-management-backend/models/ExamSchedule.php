...
class ExamSchedule {
    ...
    /**
     * Save exam schedule file info to database using PDO
     */
    public function save($fileName, $filePath, $uploadedBy, $year = null) {
        ...
        $query = "
            INSERT INTO exam_schedules (file_name, file_path, uploaded_by, year, uploaded_at, updated_at)
    ...
    /**
     * Get exam schedule for a year using PDO
     */
