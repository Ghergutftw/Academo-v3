...
export class ScheduleService {
  private apiUrl = `${environment.apiUrl}/schedule/schedule.php`;

  constructor(private http: HttpClient) { }

  /**
   * Upload an Excel file with schedule
   */
  ...
  /**
   * Download the schedule Excel file as blob
   */
  ...
  /**
   * Check if schedule file exists in database
